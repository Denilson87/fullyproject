			...
			<div class="col-md-12">
				<div class="title-box">
					<div class="page-title-heading">
						<h1 class="title">Galeria - <?php echo $titulo ?></h1>
					</div>
					<div class="breadcrumb-wrapper">
						...
						<span class="actual">Galeria - <?php echo $titulo ?></span>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12" style="margin-top: 40px">
				<div class="sec-title-span text-center" style="margin-bottom: 0">
					<span class="title">Galeria - <?php echo $titulo ?></span>
				</div>

				<div class="page-content pages-content-right" style="margin-top: 0">
					<div id="gallery" class="albuns-view" style="display:none;">
						<?php foreach ($items as $item){?>
							<a target="_parent" href="<?php echo base_url('galeria_album/'.$item->id_album) ?>">
								<img alt="<?php echo $item->descricao ?>"
									 src="<?php echo base_url('media/'.$item->foto) ?>"
