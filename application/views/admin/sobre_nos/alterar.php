<div class="card">
	<div class="card-body">
		<form method="post" action="<?php echo admin_url('sobre_nos/update/'.$sobre->id)?>" enctype="multipart/form-data">
			<div class="row">
				<div class="col-md-12">
					<div class="row">
						<div class="form-group col-md-12">
							<label for="titulo">Titulo</label>
							<input type="text" class="form-control" value="<?php echo $sobre->titulo ?>" name="titulo" id="titulo" placeholder="Escreva o Titulo">
						</div>

						<div class="form-group col-md-12">
							<label for="corpo">Corpo</label>
							<textarea type="text" rows="16" class="form-control" name="corpo" id="corpo"><?php echo $sobre->corpo ?></textarea>
						</div>
						...
						<div class="form-group col-md-12">
							<div class="row">
								<div class="form-group col-md-4">
									...
									<textarea type="text" rows="16" class="form-control" name="missao" id="missao"><?php echo $sobre->missao ?></textarea>
								</div>

								<div class="form-group col-md-4">
									<label for="introducao">Visão</label>
									<textarea type="text" rows="16" class="form-control" name="visao" id="visao"><?php echo $sobre->visao ?></textarea>
								</div>

								<div class="form-group col-md-4">
									<label for="introducao">Valores</label>
									<textarea type="text" rows="16" class="form-control" name="valores" id="valores"><?php echo $sobre->valores ?></textarea>
								</div>
							</div>
						</div>
					</div>
...
<script>
	...
	tinymce.init({
		selector: 'textarea',
		plugins: 'advlist autolink lists link image charmap print preview hr anchor pagebreak',toolbar_mode: 'floating',
