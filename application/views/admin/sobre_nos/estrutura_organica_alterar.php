<div class="card">
	<div class="card-body">
		<form method="post" action="<?php echo admin_url('sobre_nos/estrutura_organica_update/'.$sobre->id)?>" enctype="multipart/form-data">
			<div class="tab-menu">
				...
				<div class="tab-pane fade show active" id="main" role="tabpanel" aria-labelledby="main-tab">
					<div class="row">
						...
						<div class="form-group col-md-12">
							...
							<textarea rows="10" class="form-control" name="corpo" id="corpo"><?php echo $sobre->corpo ?></textarea>
						</div>
						...
						<div id="img_selecionada" class="form-group col-md-3 hidden">
							...
							<img class="img-fluid" src="<?php echo base_url('media/'.$sobre->foto) ?>">
						</div>
					</div>
				</div>
			</div>
