<div class="form-group">
	<a class="btn btn-success bg-gradient-success" href="<?php echo admin_url('paginas/add')?>">Adicionar Pagina</a>
	<hr />
</div>
...
<table class="table table-bordered table-hover tabela-enhl">
	...
	<?php foreach ($paginas as $pagina){ ?>
		<tr>
			...
			<td> <img class="img-fluid" src="<?php echo base_url('media/'.$pagina->imagem_destaque) ?>"></td>
