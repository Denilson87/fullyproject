<div class="card">
	<div class="card-body">
		<form method="post" action="<?php echo admin_url('media/save')?>" enctype="multipart/form-data">
			<div class="row">
				...
				<div id="ficheiro-carregado" style="display: none" class="form-group col-md-4 offset-4">
