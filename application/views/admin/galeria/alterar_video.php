<div class="card">
	<div class="card-body">
		<form method="post" action="<?php echo admin_url('galeria/update_video/'.$video->id_video)?>" enctype="multipart/form-data">
			<div class="row">
				<div class="form-group col-md-6 offset-3">
					<label for="titulo">Titulo</label>
					<input type="text" class="form-control" value="<?php echo $video->titulo; ?>" name="titulo" id="titulo" placeholder="Escreva o Titulo">
				</div>

				<div class="form-group col-md-6 offset-3">
					<label for="descricao">Descrição</label>
					<input type="text" class="form-control" value="<?php echo $video->descricao; ?>" name="descricao" id="descricao" placeholder="Escreva a Descrição">
				</div>

				<div class="form-group col-md-3 offset-3">
					<label for="link_video">Link de Video</label>
					<input type="text" class="form-control" value="<?php echo $video->link_video; ?>" name="link_video" id="link_video" placeholder="https://youtube.com/">
				</div>

				<div class="form-group col-md-3">
					<label for="link_video">ID do Video</label>
					<input type="text" class="form-control" value="<?php echo $video->id_video; ?>" name="id_video" id="id_video" placeholder="j96KeC5FZnk">
				</div>

				<div class="form-group col-md-3 offset-3">
					<label for="tipo">Tipo</label>
					<select class="form-control use-select2" name="tipo" id="tipo">
						<option value="<?php echo $video->tipo; ?>"><?php echo $video->tipo; ?></option>
				...
				<div id="img_selecionada" class=" col-md-6 offset-3 hidden">
					...
					<label class="col-md-12" id="selected-media"><?php echo $video->designacao; ?></label>
					<input id="id_media" name="id_media" type="hidden"  value="<?php echo $video->id_media; ?>">
				</div>
			</div>

			<div class="row">
				<div class="form-group col-md-12" style="text-align: center; margin-top: 30px">
					<a class="btn btn-secondary" href="<?php echo admin_url('galeria/galeria_video')?>"><i class="fa fa-backward"></i>Voltar</a>
