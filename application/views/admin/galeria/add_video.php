<div class="card">
	<div class="card-body">
		<form method="post" action="<?php echo admin_url('galeria/save_video')?>" enctype="multipart/form-data">
			<div class="row">
				...
				<div class="form-group col-md-6 offset-3">
					...
					<input type="text" class="form-control" name="descricao" id="descricao" placeholder="Escreva a Descrição">
				</div>

				<div class="form-group col-md-3 offset-3">
					<label for="link_video">Link de Video</label>
					<input type="text" class="form-control" name="link_video" id="link_video" placeholder="https://youtube.com/">
				</div>

				<div class="form-group col-md-3">
					<label for="link_video">ID do Video</label>
					<input type="text" class="form-control" name="id_video" id="id_video" placeholder="j96KeC5FZnk">
				</div>
