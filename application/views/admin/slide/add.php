<div class="card">
	<div class="card-body">
		<form method="post" action="<?php echo admin_url('slide/save/'.$id_slider)?>" enctype="multipart/form-data">
			<div class="row">
				...
				<div class="form-group col-md-6">
					...
					<input type="text" class="form-control" name="descricao" id="descricao" placeholder="Escreva a Descriçao">
				</div>

				<div class="form-group col-md-12">
					<label for="introducao">Introdução</label>
					<input type="text" class="form-control" name="introducao" id="introducao" placeholder="Escreva a Introdução">
				</div>
...
<!--					<label for="descricao">Selecione a Foto</label>-->
				...
				<div class="form-group col-md-12">
					<img style="height: 100px" id="preview-selected" />
				</div>

				<div class="form-group col-md-12">
					<img src="" width="100%" class="preview-img" id="uploaded" />
				</div>
