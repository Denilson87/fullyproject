<div class="card">
	<div class="card-body">
		<form method="post" action="<?php echo admin_url('slide/update/'.$slide->id_slide)?>" enctype="multipart/form-data">
			<div class="row">
				<div class="col-md-6">
					<div class="row">
						<div class="form-group col-md-12">
							<label for="titulo">Titulo</label>
							<input type="text" class="form-control" value="<?php echo $slide->titulo ?>" name="titulo" id="titulo" placeholder="Escreva o Titulo">
						</div>

						<div class="form-group col-md-12">
							<label for="descricao">Descrição</label>
							<input type="text" class="form-control" name="descricao" value="<?php echo $slide->descricao ?>" id="descricao" placeholder="Escreva a Descriçao">
						</div>

						<div class="form-group col-md-12">
							<label for="introducao">Introdução</label>
							<textarea type="text" rows="4" class="form-control" name="introducao" id="introducao" placeholder="Escreva a Introdução"><?php echo $slide->introducao ?></textarea>
						</div>
						...
						<div class="form-group col-md-12">
							...
							<input id="id_media" name="id_media" type="hidden" value="<?php echo $slide->id_media ?>">
						</div>
					</div>
				</div>
				<div class="col-md-6">
			...
			<div class="row">
				<div class="form-group col-md-12" style="text-align: center; margin-top: 30px">
					<a class="btn btn-secondary" href="<?php echo admin_url('slider')?>"><i class="fa fa-backward"></i>Voltar</a>
