<div class="card">
	<div class="card-body">
		<form method="post" action="<?php echo admin_url('paginas/save')?>" enctype="multipart/form-data">
				<div class="tab-menu">
				...
				<div class="tab-pane fade show active" id="main" role="tabpanel" aria-labelledby="main-tab">
					<div class="row">
						...
						<div class="form-group col-md-3">
							...
							<select required class="form-control" name="sidebar" id="sidebar">
								<option value="">Seleccione a Barra Lateral</option>
						...
						<div class="form-group col-md-3">
							...
							<select required class="form-control use-select2" name="tipo" id="tipo">
						...
						<div class="form-group col-md-12">
							...
							<textarea rows="20" class="form-control" name="corpo" id="corpo"></textarea>
						</div>
					</div>
				</div>
				...
				<div class="tab-pane fade" id="sec" role="tabpanel" aria-labelledby="sec-tab">
					<div class="row">
						<div class="form-group col-md-12">
							...
							<input type="text" class="form-control" name="subtitulo" id="subtitulo" placeholder="Escreva o Subtitulo">
						</div>

						<div class="form-group col-md-12">
							<label for="introducao">Texto Introdutório <span class="form-span">(Opcional)</span></label>
							<textarea class="form-control" name="introducao" id="introducao"></textarea>
						</div>
