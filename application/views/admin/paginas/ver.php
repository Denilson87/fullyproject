			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-md-6">
						...
						<hr />
						<img class="img-fluid" src="<?php echo base_url('media/'.$pagina->imagem_destaque) ?>">
					</div>
				...
				<div class="row">
					<div class="col-md-12" style="padding-top: 30px">
						<a class="btn btn-secondary" href="<?php echo admin_url('paginas')?>">
						...
						<a class="btn btn-danger" href="<?php echo admin_url('paginas/delete/'.$pagina->id_pagina)?>">
