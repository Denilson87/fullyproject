<div class="card">
	<div class="card-body">
		<form method="post" action="<?php echo admin_url('paginas/update/'.$pagina->id_pagina)?>" enctype="multipart/form-data">
			<div class="tab-menu">
				<ul class="nav nav-tabs" id="myTab" role="tablist">
					...
					<li class="nav-item">
						<a class="nav-link" id="sec-tab" data-toggle="tab" href="#sec" role="tab" aria-controls="sec" aria-selected="false">Campos Opcionais (Subtitulo, introdução ...)</a>
					</li>
				</ul>
			</div>
			...
			<div class="tab-content" id="tab-content">
				<div class="tab-pane fade show active" id="main" role="tabpanel" aria-labelledby="main-tab">
					<div class="row">
						<div class="form-group col-md-12">
							...
							<input type="text" class="form-control" value="<?php echo $pagina->titulo ?>" name="titulo" id="titulo" placeholder="Escreva o Titulo">
						</div>

						<div class="form-group col-md-2">
							<label for="sidebar">Sidebar</label>
							<select required class="form-control" value="<?php echo $pagina->sidebar ?>" name="sidebar" id="sidebar">
								<option value="<?php echo $pagina->sidebar ?>"><?php echo $pagina->sidebar ?></option>
								<?php foreach ($widgets as $widget){ ?>
									<option value="<?php echo $widget->titulo ?>"><?php echo $widget->titulo ?></option>
								<?php } ?>
							</select>
						</div>
						...
						<div class="form-group col-md-2">
							...
							<select required class="form-control" value="<?php echo $pagina->tipo ?>" name="tipo" id="tipo">
								<option value="<?php echo $pagina->tipo ?>"><?php echo $pagina->tipo ?></option>
						...
						<div id="img_selecionada" class="form-group col-md-4 hidden">
							<label class="col-md-12" for="imagem">Imagem Selecionada</label>
							<label class="col-md-12" id="selected-media"><?php echo $pagina->imagem_destaque ?></label>
							<input id="imagem_destaque" name="imagem_destaque" type="hidden" value="<?php echo $pagina->imagem_destaque ?>">
						</div>

						<div class="form-group col-md-12">
							<label for="corpo">Corpo</label>
							<textarea rows="20" class="form-control" name="corpo" id="corpo"><?php echo $pagina->corpo ?></textarea>
						</div>
					</div>
				</div>
				...
				<div class="tab-pane fade" id="sec" role="tabpanel" aria-labelledby="sec-tab">
					<div class="row">
						<div class="form-group col-md-12">
							<label for="subtitulo">Subtitulo <span class="form-span">(Opcional)</span></label>
							<input type="text" class="form-control" value="<?php echo $pagina->subtitulo ?>" name="subtitulo" id="subtitulo" placeholder="Escreva o Subtitulo">
						</div>

						<div class="form-group col-md-12">
							<label for="introducao">Texto Introdutório <span class="form-span">(Opcional)</span></label>
							<textarea rows="8" class="form-control" name="introducao" id="introducao"><?php echo $pagina->introducao ?></textarea>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group col-md-12" style="text-align: center; margin-top: 30px">
					<a class="btn btn-secondary" href="<?php echo admin_url('paginas')?>"><i class="fa fa-backward"></i>Voltar</a>
