<div class="card">
	<div class="card-body">
		<form method="post" action="<?php echo admin_url('portfolio/update/'.$pagina->id)?>" enctype="multipart/form-data">
			<div class="tab-menu">
				...
				<div class="tab-pane fade show active" id="main" role="tabpanel" aria-labelledby="main-tab">
					<div class="row">
						...
						<div class="form-group col-md-3">
							<label for="sidebar">Categoria</label>
							<select required class="form-control" value="<?php echo $pagina->categoria ?>" name="categoria" id="categoria">
								<option value="">Seleccione a Categoria</option>
								<?php foreach ($categorias as $categoria){ ?>
									<option value="<?php echo $categoria->designacao ?>"><?php echo $categoria->designacao ?></option>
								<?php } ?>
							</select>
						</div>
						...
						<div class="form-group col-md-3">
							...
							<select required class="form-control use-select2" value="<?php echo $pagina->tipo ?>" name="tipo" id="tipo">
						...
						<div id="img_selecionada" class="form-group col-md-3 hidden">
							...
							<img class="img-fluid" style="width: 50%" src="<?php echo base_url('media/'.$pagina->foto) ?>">
						</div>
				...
				<div class="tab-pane fade" id="sec" role="tabpanel" aria-labelledby="sec-tab">
					<div class="row">
						<div class="form-group col-md-12">
							...
							<textarea class="form-control" name="introducao" id="introducao"><?php echo $pagina->introducao ?></textarea>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group col-md-12" style="text-align: center; margin-top: 30px">
					<a class="btn btn-secondary" href="<?php echo admin_url('portfolio')?>"><i class="fa fa-backward"></i>Voltar</a>
